...
object ProjectCardBinder {
    ...
    fun bind(card: View, context: Context, idea: ProjectIdea, apiService: ApiService, fragment: androidx.fragment.app.Fragment? = null) {
        ...
        UserUtils.getUserInfo(idea.createdBy.id, apiService) { userInfo ->
        ...
        backGithub.text = if (!idea.githubLink.isNullOrEmpty()) "GitHub: ${idea.githubLink}" else "GitHub: Not available"
